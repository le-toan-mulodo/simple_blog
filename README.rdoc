...
Set Up:
  ...
  + rake db:seed to initilize some data for development enviroment (you can append into it to indicate the environment you want like development default, production, test: rake db:seed RAILS_ENV=test)
